...
function App() {
  ...
  // 1. Theme toggle function - switches between dark (luxury gold) and light
  const ToggleTheme = () => {
    const newTheme = currentTheme === 'light' ? 'dark' : 'light';
    setCurrentTheme(newTheme);
  };

  // 2. Apply the theme to the document (Effect)
  useEffect(() => {
      ...
      <div className="col-md-4 mb-4 text-center">
        <h5 className="fw-bold mb-3 text-primary">Quick Links</h5>
         <ul className="list-unstyled p-0">
          ...
          <li className="mb-2"><a href="#project" className="text-secondary text-decoration-none small hover-link">💻 Projects </a></li>
          <li className="mb-2"><a href="#contact" className="text-secondary text-decoration-none small hover-link">📞 Contact </a></li>
           <li className="mb-2"><a href="#skill" className="text-secondary text-decoration-none small hover-link">🤹 Skilles </a></li>
        </ul>
      </div>

      {/* 3. Socials Section (ያንተ የድሮው ኮድ ተስተካክሎ) */}
      <div className="col-md-4 mb-4 text-center text-md-end">
        <h5 className="fw-bold mb-3 text-primary">Follow Me on Socials</h5>
