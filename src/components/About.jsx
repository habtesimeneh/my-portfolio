...
function About() {
  return (
    <section id="about" className="py-5 about-section">
      <Container>
        <h2 className="display-5 fw-bold text-center mb-5">About <span className="text-gold">Me</span></h2>
        
        <Row className="align-items-center">
          {/* ግራ በኩል - አጭር መግቢያ */}
          <Col lg={6} className="mb-4 mb-lg-0">
          <div className="about-text p-3 p-md-4">
  <h2 className="fw-bold mb-4" data-aos="fade-up">About Me</h2>
  <p className="lead" data-aos="fade-up" data-offset="100">
  ...
  <p className="lead" data-aos="fade-up" data-offset="200">
    ...
    to a polished, <strong>final outcome</strong>.
          ...
          <Col lg={6}>
            <Row className="g-3 g-md-4">
              <Col xs={12}>
                <Card className="about-card border-0 shadow-sm p-3">
                  <div className="d-flex align-items-center">
                    <FaGraduationCap size={40} className="about-icon me-3" />
                    <div>
              ...
              <Col xs={12}>
                <Card className="about-card border-0 shadow-sm p-3">
                  <div className="d-flex align-items-center">
                    <FaCode size={40} className="about-icon me-3" />
                    <div>
              ...
              <Col xs={12}>
                <Card className="about-card border-0 shadow-sm p-3">
                  <div className="d-flex align-items-center">
                    <FaLightbulb size={40} className="about-icon me-3" />
                    <div>
